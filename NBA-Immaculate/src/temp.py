            ...
            if player_link:
                ...
                if url_var in player_url:
                    if player_name not in player_names:
                        ...
                        for i, td in enumerate(season_th_elements):
                            season_link = td.find('a')
                            if season_link:
                                if i == 0:
                                    p.years.append(season_link)
                                if i == len(season_th_elements)-1:
                                    p.years.appebd(season_link)
